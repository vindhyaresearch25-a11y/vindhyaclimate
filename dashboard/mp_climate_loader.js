...
(function(){
  ...
  var CROP_DATA = {
    soilTypes: {
      ...
      vindhya:   {name:'Red & Yellow Loam',    zones:['rewa','sidhi','satna','maihar','mauganj','singrauli','shahdol','umaria','anuppur','katni'], crops_kharif:['Rice','Kodo Millet','Pigeonpea','Black Gram'], crops_rabi:['Wheat','Gram','Linseed','Mustard'], crops_zayed:['Watermelon','Moong','Cowpea'], fert:'NPK @ 60:40:40 kg/ha + Zinc @ 25 kg/ha', irrigation:'Rainfed predominant. Farm ponds & check dams recommended.'},
